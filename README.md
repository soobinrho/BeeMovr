...
What's more -- because of this they have to manually go through Google Maps with precipitation data and do the math for each area to find a candidate to move into.
