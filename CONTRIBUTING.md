...
When contributing a major change, please first discuss the change you wish to make via GitHub issues.
Minor issues can simply be addressed by sending by a pull request.

All pull requests will require you to ensure the change is certified via the [Developer Certificate of Origin (DCO)](https://github.com/apps/dco/).
...
reported by contacting soobin &lt;soobinrho@nsustain.com&gt;.
