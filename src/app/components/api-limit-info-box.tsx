        ...
        {shouldShowApiLimitInfoBox ? (
          <div className='relative mx-4 my-16 whitespace-break-spaces rounded-md bg-background-console/90 p-4 text-left text-sm text-font-console sm:mx-[25%] sm:px-16 sm:py-20 sm:text-base'>
            ...
            <p className='font-normal'>
              ...
              free tier APIs) until we implement a feature to limit our website
              to 50,000 loads per month because otherwise we can accidentally be
              billed $$$$... We will re-enable our map once the rate limit
              control is in place.
            </p>
          </div>
        ) : (
