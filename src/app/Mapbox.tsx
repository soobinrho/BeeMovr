  ...
  return (
    <div>
      <div className='absolute z-10 grid grid-cols-2'>
        <div className='m-2 p-3 hover:bg-background-space/50'>
          <b>Longitude</b> {viewport.longitude.toFixed(6)}
          <br />
          <b>Latitude</b> {viewport.latitude.toFixed(6)}
        </div>
        <div className='invisible z-10 mx-5 my-5 sm:visible'>
          <a
            target='_blank'
      ...
      {/* <div className='absolute z-10 m-2 p-3 hover:bg-background-space/50'>
        <b>Longitude</b> {viewport.longitude.toFixed(6)}
        <br />
        <b>Latitude</b> {viewport.latitude.toFixed(6)}
      </div>
